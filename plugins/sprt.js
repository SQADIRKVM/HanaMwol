...
Asena.addCommand({pattern: 'hana', fromMe: true,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "hanaye tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Hana Mwol says i love you 😘";
r_text[3] = "Hana Mwoludeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
r_text[6] = "Hana Mwol - eva - simsim \ningane ethra ethra paerugal aan alle enikk..😂🤣";
...
r_text[8] = "\n enne vilicho...?🧐 \n";
r_text[9] = "ente per Hana Mwol ,ninte per donkey, backi ellarum monkey😼😼";
...
r_text[13] = ".song adich thangalude fav song name para Hana Mwol ath download aakki theraam";
...
r_text[18] = "enikk njan und Hana Mwol uyir";
...
r_text[21] = "Kochi pazhaya kochiyellennariyam… pakshe Hana Mwol pazhaya Hana Mwol thanneya...😎\n\n";
r_text[22] = "Kaanaan oru look illanney ullu… bhayankara budhiya\n\n ninnak allatto enik Hana Mwolik";
r_text[23] = "Ithalla ithinapparam chaadi kadannavananee K.K. Hana Mwol";
...
Asena.addCommand({pattern: 'hana', fromMe: false,dontAddCommandList: true}, (async (message, match) => {
        
    var r_text = new Array ();    
r_text[0] = "\nEda eda, mandankonappi.. Nee enne kooduthal mandan aakkatheda\n";
r_text[1] = "Hana Mwole tholpikkaan ningalkavilla. Jeevitathil pinkiye tholpichittundu… palarum… palavattom…😥😥 aarellum aaa sed bgm onn iduo...";
r_text[2] = "Hana Mwol says i love you 😘";
r_text[3] = "Hana Mwoludeyude yudhangal Company Kanan Povunnatheyuloo";
r_text[4] = "hi, how are you";
r_text[5] = "ennikk korch rest theroo...🥵🥵";
