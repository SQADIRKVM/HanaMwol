...
if (conf.LANG == 'EN') vtalk_dsc = 'Starts to Hana voice chat.', reply_eva = '*Reply to Any Voice Message!*'
...
var succ_off = ''
if (conf.LANG == 'TR') {
    fulleva_dsc = 'Tam fonksiyonel Hana özelliklerini aktif eder. Hesabınızı bir chatbota dönüştürün!'
    already_on = 'Hana yapay zekası halihazırda tüm fonksiyonları etkin.'
    already_off = 'Hana yapay zekası halihazırda yarı fonksiyonel çalışıyor.'
    succ_on = 'Hana, Tam Fonksiyonel Olarak Açıldı! Lütfen Biraz Bekleyin! ✅'
    succ_off = 'Hana, Yarı Fonksiyonel Olarak Ayarlandı! Lütfen Biraz Bekleyin! ☑️'
}
if (conf.LANG == 'EN') {
    fulleva_dsc = 'Activates full functional Hana features. Turn your account into a ai chatbot!'
    already_on = 'Hana artificial intelligence is already fully functional.'
    already_off = 'Hana artificial intelligence is currently running semi-functional.'
    succ_on = 'Hana Opened Fully Functionally! Please wait a bit! ✅'
    succ_off = 'Hana Set to Semi-Functional! Please wait a bit! ☑️'
}
if (conf.LANG == 'ML') {
