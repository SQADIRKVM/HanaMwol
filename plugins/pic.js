/* # Coded by raashii redited by sqadir
 */ 
...
if (Config.WORKTYPE == 'private') {
  ...
  Asena.addCommand({ pattern: 'pic ?(.*)', fromMe: true, desc: Lang.SQADIR_DESC }, async (message, match) => {
  ...
  Asena.addCommand({ pattern: 'pic ?(.*)', fromMe: false, desc: Lang.SQADIR_DESC }, async (message, match) => {
